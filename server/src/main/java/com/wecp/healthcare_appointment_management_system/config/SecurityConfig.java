...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                .authorizeRequests()
                .antMatchers("/api/user/**", "/api/all/**" , "/api/doctors/register", "/api/patient/register","/api/receptionist/register", "/api/user/login", "/health", "/api/receptionist/appointment/**", "/api/patient/doctors").permitAll()
                .antMatchers(HttpMethod.GET, "/api/patient/doctors", "/api/patient/appointments").hasAnyAuthority("PATIENT", "RECEPTIONIST")
                .antMatchers(HttpMethod.POST, "/api/patient/appointment").hasAnyAuthority("PATIENT")
                ...
                .antMatchers(HttpMethod.GET, "/api/receptionist/appointments").hasAnyAuthority("RECEPTIONIST")
                .antMatchers(HttpMethod.GET, "/receptionist/**", "/api/receptionist/**").hasAnyAuthority("RECEPTIONIST")                
                .antMatchers(HttpMethod.POST,"/api/doctor/availability" ).hasAnyAuthority("DOCTOR")
