...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/api/patient/appointments/**", "/api/patient/medicalrecord").hasAnyAuthority("PATIENT", "RECEPTIONIST")
                .antMatchers(HttpMethod.PUT, "/api/patient/medicalrecord").hasAnyAuthority("PATIENT", "RECEPTIONIST")
                .antMatchers(HttpMethod.DELETE, "/api/patient/medicalrecord", "/api/delete/appointment/**").hasAnyAuthority("PATIENT", "RECEPTIONIST")
